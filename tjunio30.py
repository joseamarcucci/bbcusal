...
# Create the pandas DataFrame
    ...
    df = pd.read_csv('https://docs.google.com/spreadsheets/d/1hU7BeCFoT1Bbr5TBPajd9MxZwdXvlfC1S8Ms254nDLQ/export?format=csv')
    ...
    st.sidebar.write('Minutos/totales: ',48269353+round(timesu,0))
    df8 = pd.DataFrame({
