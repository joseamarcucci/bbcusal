...
import home, data_stats,tmayo,tmayo2,meses,mesesxuym,home5,moodle5,tjunio30,todas0,todasu,moodle,abril25,tjunio1,graba,tfebrero,tmarzo,tabril,home4,home2,moodle2,moodle4,usuarios,usuarios0,usuariosbbc # import your app modules here
...
app.add_app("Junio30", tjunio30.app)
#app.add_app("16 al 21 de abril", data_stats.app)
#app.add_app("22 al 25 de abril", abril25.app)
